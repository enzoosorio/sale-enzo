...
export default function LoginPage() {
  return (
    <section className="relative min-h-screen flex items-center justify-center p-4">
      {/* sillye svg head */}
      <svg width="820" height="613" viewBox="0 0 820 613" fill="none" className="absolute top-1/4 right-10">
      ...
      {/* Login Card */}
      <div className={`w-full min-w-[320px] xl:min-w-[600px] 
        max-w-md bg-[#0c0c0c10] backdrop-blur-[5px] 
        flex flex-col items-start justify-start 
        rounded-2xl shadow-lg p-8 gap-8`}>
       ...
       <div className="flex flex-col items-start justify-start gap-8 w-full">
          ...
          {/* Register Link */}
          <p className="text-center font-nanum text-sm text-foreground/70">
            ¿No tienes cuenta?{" "}
