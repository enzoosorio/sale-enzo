...
export const SuperBarraBusqueda = () => {
  ...
  return (
    ...
    <form
      ...
      className="absolute top-0 left-1/2 -translate-x-1/2 bg-white w-1/2 mx-auto focus:shadow-2xl focus-within:shadow-xl transition-shadow h-10 shadow-lg flex items-center justify-between"
      style={{ zIndex: 10 }}
    >
      <input 
      onFocus={() => {
